...
if($_SERVER["REQUEST_METHOD"]!="POST"){
	...
	runDif($connection,$DataTable,$QTable,$DifCol,$_POST['pA'],$_POST['pAR'],$_POST['pD'],$_POST['pS'],$Drop,0);
...
FUNCTION runDif($connection,$DataTable,$QTable,$DifCol,$pA,$pAR,$pD,$pS,$Drop,$Dbug){
	...
	FOREACH($types as $QType){
		...
		WHILE ($row = mysql_fetch_array($result)){
			...
			if(updateDif($connection,$DataTable,$QTable,$DifCol,$pA,$pAR,$pD,$pS,$row['id'],$QType,$Drop,$Dbug))
...
FUNCTION updateDif($connection,$DataTable,$QTable,$DifCol,$pA,$pAR,$pD,$pS,$tag_id,$QType,$Drop,$Dbug){
	$ran  = 1;
