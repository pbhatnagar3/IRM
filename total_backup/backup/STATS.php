...
class STATS
{
    ...
    function load() // Loads STAT for given chapter
    {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS " . $this->table_name . " (" . "id		  				  int NOT NULL  AUTO_INCREMENT,				 " . "question_id		  int,				 " . "concept_id			  int,				 " . "current_chapter	int, 				 " . "answered 				varchar(1024), " . "score 					  float, 			 " . "rating 					int, 				 " . "comment 					varchar(128)," . "tags			  varchar(256)," . "epochtime       int(10) unsigned," . "duration        int(11)," . "event           varchar(63)," . "PRIMARY KEY (id),		 " . "FOREIGN KEY (concept_id) REFERENCES concept (id) ON DELETE SET NULL " . ")";
