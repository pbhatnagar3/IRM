...
---NEW---*/
    ...
    function render_data() {
        ...
        $ts = new ITS_tag($this->tb_tags.'_its');
        ...
        $style = 'ITS';
        $css   = 'ITS_QUESTION_DB';
        $dbT = '<tr><th colspan="6">Tags: '.$sb.'</th></tr><tr><td colspan="7">'.$Q_T_list.'<hr class="ITS">'.$Q_T_sys_list.$sbr.'</td></tr>';
        $db1 = '<tr><th colspan="2">Title</th><th>Ans</th><th>Category</th><th>Questions<br>config</b></th><th>Answers<br>config</th></tr>' .
                '<tr>' .
