...
*/
    ...
    $("li[name='qtype']").live('click', function (event) {
        ...
        case 'mc':
            ...
            for (a = 1; a <= n; a++) {
                ans += '<tr>' + '<td width="10%"><label for="answer' + a + '">answer&nbsp;' + a + '</label></td>' + '<td width="60%"><textarea name="answer' + a + '" id="answer' + a + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="weight' + a + '">weight&nbsp;' + a + '</label></td>' + '<td width="20%"><input type="text" name="weight' + a + '" id="weight' + a + '" value="" class="' + css + '" /></td>' + '</tr>';
            }
        ...
        case 'm':
            ...
            ans = '<table id="ITS_Qans" class="ITS_Qans" n="' + n + '" qtype="' + qtype + '">';
            for (a = 1; a <= n; a++) {
                ans += '<tr>' + '<td width="10%"><label for="L' + a + '">L&nbsp;' + a + '</label></td>' + '<td width="50%"><textarea name="L' + a + '" id="answer' + a + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="R' + a + '">R&nbsp;' + a + '</label></td>' + '<td width="50%"><textarea name="R' + a + '" id="R' + a + '" value="" class="' + css + '" /></td>' + '</tr>';
            }
            ans += '</table>' + '<input type="hidden" name="answers" id="answers" value="' + n + '" />';
            ans = '<td>' + lbl + sel + '</td>' + '<td>' + ans + '</td>';
            break;
        ...
        case 'c':
            ...
            for (a = 1; a <= n; a++) {
                ans += '<tr>' + '<td width="10%"><label for="value' + a + '">value&nbsp;' + a + '</label></td>' + '<td width="40%"><input type="text" name="val' + a + '" id="answer' + a + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="minvalue' + a + '">min</label></td>' + '<td width="10%"><input type="text" name="min_val' + a + '" id="minvalue' + a + '" value="" class="' + css + '"/></td>' + '<td width="10%"><label for="maxvalue' + a + '">max</label></td>' + '<td width="10%"><input type="text" name="max_val' + a + '" id="maxvalue' + a + '" value="" class="' + css + '"/></td>' + '</tr>';
            }
            ans += '</table>';
            ans = '<td>' + lbl + sel + '</td>' + '<td>' + ans + '</td>';
            break;
    ...
    $('#add_fcount').live('click', function () {
        ...
        if (new_value <= 4) {
            ...
            var tr = '<tr id="tr_formula' + new_value + '">' + '<td width="10%"><label for="text' + new_value + '">Text ' + new_value + '</label></td>' + '<td width="30%" ><textarea name="text' + new_value + '" id="text' + new_value + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="formula' + new_value + '">Formula ' + new_value + '</label></td>' + '<td width="90%" colspan="6"><textarea name="formula' + new_value + '" id="formula' + new_value + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="weight' + new_value + '">Weight ' + new_value + '</label></td><td width="40%"><input type="text" MAXLENGTH=3 name="weight' + new_value + '" class="' + css + '" id="weight' + new_value + '"></td>' + '</tr>';
    ...
    $("input[name=changeAnswer]").live('click', function (event) {
        ...
        case '+':
            if (n < 23) {
                switch (qtype) {
                case 'mc':
                    td = '<td width="10%"><label for="answer' + n1 + '">answer&nbsp;' + n1 + '</label></td>' + '<td width="40%"><textarea name="answer' + n1 + '" id="answer' + n1 + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="weight' + n1 + '">weight&nbsp;' + n1 + '</label></td>' + '<td width="40%"><input type="text" name="weight' + n1 + '" id="weight' + n1 + '" value="" class="' + css + '" /></td>';
                    break;
                case 'm':
                    //alert('aa');											
                    td = '<td width="10%"><label for="L' + n1 + '">L&nbsp;' + n1 + '</label></td>' + '<td width="50%"><textarea name="L' + n1 + '" id="answer' + n1 + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="R' + n1 + '">R&nbsp;' + n1 + '</label></td>' + '<td width="50%"><textarea name="R' + n1 + '" id="R' + n1 + '" value="" class="' + css + '" /></td>';
                    //alert(td);	 
                    break;
                case 'c':
                    //alert(qtype+' '+n);
                    td = '<td width="10%"><label for="value' + n1 + '">value&nbsp;' + n1 + '</label></td>' + '<td width="20%"><input type="text" name="val' + n1 + '" id="answer' + n1 + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="minvalue' + n1 + '">min</label></td>' + '<td width="20%"><input type="text" name="min_val' + n1 + '" id="minvalue' + n1 + '" value="" class="' + css + '" /></td>' + '<td width="10%"><label for="maxvalue' + n1 + '">max</label></td>' + '<td width="20%"><input type="text" name="max_val' + n1 + '" id="maxvalue' + n1 + '" value="" class="' + css + '" /></td>';

                    $("#vals").attr("value", n1);
                    break;
                case 's':
                    //alert(qtype+' '+n);
                    td = '<td width="15%"><label for="answer' + n1 + '">answer&nbsp;' + n1 + '</label></td>' + '<td width="25%"><textarea name="ans' + n1 + '" id="answer' + n1 + '" value="" class="' + css + '" /></td>';
                    break;
                }
    ...
    $("a.[name='ITS_EDIT']").live('click', function (event) {
      ...
      //alert(matches.length+' : '+matches[0]+' '+matches[1]+' '+matches[2]);
        ...
        } else var TXA_str = '<textarea class="ITS_EDIT" id="TXA_' + tar_id + '" style="height:' + ht + 'px;width:' + wt + 'px">' + str + '</textarea>';
        //alert('TXA_'+tar_id);
