...
$query	= 'SELECT dspfirst_id FROM dspfirst_tags WHERE tags_id IN (SELECT tags_id FROM questions_tags WHERE questions_id='.$qid.');';
...
foreach($dsp_arr as $iid){
	...
	$mysql	=	'INSERT IGNORE INTO questions_dspfirst ( questions_id,dspfirst_id ) VALUES ('.$qid.', '.$iid[0].');';
	//echo $mysql.'<br>';
