...
for B in range (0, len(test.general_stats)):
	if (test.general_stats[B][0] == 'aliasing'):
		print 'Total Questions:'
		print [test.general_stats[B][0], test.general_stats[B][2]]
	if (test.general_stats[B][0] == 'beat'):
		print 'Map ID:'
		print [test.general_stats[B][0], test.general_stats[B][3]]
	if (test.general_stats[B][0] == 'angle'):
		i = B
	if (test.general_stats[B][0] == 'phase'):
		j = B		
	if (test.general_stats[B][0] == 'C-to-D'):
		k = B
print 'Cross Correlation:'
print [test.cross_correlation[i][j]]
print 'Total Correlation:'
print [test.general_stats[k][4]]
